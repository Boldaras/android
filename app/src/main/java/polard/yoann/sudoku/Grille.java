...
public class Grille extends View {
    ...
    private void init() {
        ...
        if(etatPartie.equals("0")){
            System.out.println("noir");
            paint5.setColor(Color.BLACK);
        }
        if(etatPartie.equals("1")){
            System.out.println("rouge");
            paint5.setColor(Color.RED);
        }
        if(etatPartie.equals("2")){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int j = 0; j<=w ; j+=n){
            canvas.drawLine(0, j, w, j, paint1);
        }

        canvas.drawLine(3*n, 0, 3*n, w, paint3);
        canvas.drawLine(6*n, 0, 6*n, w, paint3);
        canvas.drawLine(0, 3*n, w, 3*n, paint3);
        canvas.drawLine(0, 6*n, w, 6*n, paint3);
        ...
        canvas.drawLine(9*n, 9*n, 9*n, 0, paint5);
        canvas.drawLine(9*n, 0, 0, 0, paint5);
